<nav x-data="{ open: false }" class="bg-grey-800 border-b border-grey-900">
    @php
        $userRole = Auth::check() ? strtolower(Auth::user()->rolename ?? '') : '';
    @endphp
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            @if (in_array($userRole, ['assistent', 'praktijkmanagement']))
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            @if (in_array($userRole, ['mondhygienist', 'praktijkmanagement']))
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
