                ...
                @forelse ($users as $user)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('praktijkmanagement.confirmDelete', $user->id ?? $user->Id) }}"
                               class="btn btn-danger btn-sm">Verwijderen</a>
                        </td>
                        <td class="text-center">
                            <a href="{{ route('praktijkmanagement.edit', $user->id ?? $user->Id) }}" class="btn btn-success btn-sm">Wijzig</a>
                        </td>
                        <td class="text-center">
                            <a href="{{ route('praktijkmanagement.show', $user->id ?? $user->Id) }}" class="btn btn-warning btn-sm">Details</a>
                        </td>
                    </tr>
                @empty
                    <tr>
